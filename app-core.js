...
function applyStaticAppLanguage(){
  ...
  attr('#settingsAvatarBtn','aria-label','Menú de Patrick Training');attr('#closeStartChoiceBtn','aria-label','Cerrar');attr('#closeSessionBtn','aria-label','Cerrar sesión');attr('#sessionDemoBtn','aria-label','Ver demostración');attr('#sessionAudioBtn','aria-label','Escuchar pronunciación');
}
