...
if('serviceWorker' in navigator){
  ...
  window.addEventListener('load',async()=>{
    try{serviceWorkerRegistration=await navigator.serviceWorker.register('./sw.js?v7111-r1');serviceWorkerRegistration.addEventListener?.('updatefound',()=>{pwaUpdateState='update-found';emitPwaStatus()});syncInstallUI();emitPwaStatus()}
